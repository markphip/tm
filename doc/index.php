...
<div id="maincontent">
	<div id="midcolumn">
    	...
    	<h2>Use Cases</h2>
    	<ul>
    	<li><a href="DSDPTM_Use_Cases_v1.1c.pdf">DSDP-TM Use Cases v1.1c.pdf</a></li>
    	<li><a href="nucleus_edge_target_usecase.pdf">nucleus edge target usecase.pdf</a></li>
    	</ul>

		<h2>Design Documents</h2>
		<ul>
	    <li><a href="../meetingnotes/ff01_chicago/DSDPTM_Overview.ppt">DSDP-TM Overview (ppt)</a></li>
		<li><a href="DSDPTM_Design_Proposal_v0.3.pdf">DSDP-TM Design Proposal v0.3.pdf</a></li>
		<li><a href="DSDPTM_Target_Connection_Adapter_Proposal.pdf">DSDP-TM Target Connection Adapter Proposal.pdf</a></li>
